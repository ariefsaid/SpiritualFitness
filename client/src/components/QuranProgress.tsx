...
export default function QuranProgress() {
  ...
  const totalPages = readings.reduce((sum, reading) => sum + (reading.timeSpent / 5), 0);
  const totalMinutes = readings.reduce((sum, reading) => sum + reading.timeSpent, 0);
      ...
      <div className="bg-white dark:bg-slate-800 rounded-lg shadow-sm p-6 mb-6 border border-slate-200 dark:border-slate-700">
        <div className="flex flex-col md:flex-row">
          <div className="md:w-1/3 mb-4 md:mb-0 md:pr-6">
            ...
            <Link href="/quran">
              <a className="w-full bg-primary hover:bg-primary-dark text-white rounded-lg py-3 font-medium transition flex items-center justify-center">
